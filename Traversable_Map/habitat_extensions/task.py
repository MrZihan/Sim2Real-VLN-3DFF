...
@registry.register_dataset(name="VLN-CE-v1-HM3D")
class RxRVLNCEDatasetV1_HM3D(Dataset):
    r"""Loads the RxR VLN-CE Dataset."""

    episodes: List[VLNEpisode]
       
    def get_scenes_to_load(self, config=None):
        r"""Return a sorted list of scenes"""
...
@registry.register_dataset(name="RxR-VLN-CE-v1-HM3D")
class RxRVLNCEDatasetV1_HM3D(Dataset):
    r"""Loads the RxR VLN-CE Dataset."""
